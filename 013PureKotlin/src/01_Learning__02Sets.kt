...
fun main() {
    ...
    val solarSystem = setOf<String>("Mercury", "Venus", "Earth", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Nepturne")
    ...
    */
    ...
    val newSolarSystem = mutableSetOf("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Nepturne", "Saturn", "Uranus", "Nepturne")
    println()
